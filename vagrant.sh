...
if  [ -f "Vagrantfile" ]; then
    ...
    echo "Vagrant file does not exist."
fi

# RUN COMMAND.SH FILE TO INSTALL AND CONFIGURE THE MASTER MACHINE

if [ -f "commands.sh" ]; then
    echo "commands.sh exists."
    source commands.sh
else
    echo "command.sh file does not exist."
fi
